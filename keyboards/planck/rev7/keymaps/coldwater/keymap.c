...
enum planck_layers { _COLEMAK, _LOWER, _RAISE, _PLOVER, _ADJUST, _FUNCTION, _MOUSE };
...
enum {
    TD_XX_PRV, // hyprland pin-tile toggle / previous track
...
tap_dance_action_t tap_dance_actions[] = {
    [TD_XX_PRV] = ACTION_TAP_DANCE_DOUBLE(LGUI(KC_F9), KC_MPRV),
...
// shortcuts
#define AIRPT LGUI(KC_F8)
#define PRINT LGUI(KC_BSLS)
...
/* Colemak
 * ,-----------------------------------------------------------------------------------.
 * |   Q  |   W  |   F  |   P  |   B  |XX/Prv|Ply/Nx|   J  |   L  |   U  |   Y  |   '  |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |A/Ctrl|R/GUI |S/Alt |T/Shft|   G  | RAlt |AirPt |   M  |N/Shft|E/Alt |I/GUI |O/Ctrl|
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |   Z  |   X  |   C  |   D  |   V  | Vol- | Vol+ |   K  |   H  |  ,;  |  .:  |  /\  |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Bri- |      |Esc/Ms|Bk/Lwr|LShift|  Del |  Tab |Space |Ent/Rs|Tab/Fn|      | Bri+ |
 * `-----------------------------------------------------------------------------------'
 */
[_COLEMAK] = LAYOUT_planck_grid(
    KC_Q,    KC_W,     KC_F,    KC_P,   KC_B,    TDXXPR,  TDPLNX,  KC_J,   KC_L,    KC_U,    KC_Y,    KC_QUOT,
    CTLA,    GUIR,     ALTS,    SFTT,   KC_G,    KC_RALT, AIRPT,   KC_M,   SFTN,    ALTE,    GUII,    CTLO,
 ...
 * |   `  |      |   (  |   )  |      |      |      |      |   7  |   8  |   9  |   =  |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl | GUI  |[/Alt |]/Shft|      |      |      |      |4/Shft|5/Alt |6/GUI |-/Ctrl|
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |      |Print |      |      |      |      |   1  |   2  |   3  |   /  |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |      |██████|      |      |      |Space |   0  |      |   .  |      |
 ...
 * |      |      |      |      |      |      |      | PgUp | Home |  Up  |  End |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl | GUI  |  Alt |Shift |      |      |      | PgDn | Left | Down |Right |  Ins |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |      |      |      |      |      |      |      |      |      |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |      |      |      |      |      |      |██████|      |      |      |
 ...
 *                      v------------------------RGB CONTROL--------------------v
 * ,-----------------------------------------------------------------------------------.
 * |      | Boot |Debug |RGB Tg|RGB Nx| Hue+ | Hue- | Sat+ | Sat- |Spd + |Spd - |  Del |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |EEClr |MusNxt|Aud On|AudOff|AGNorm|AGSwap|      |Colmak|      |Plover|      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |AuPrev|AuNext|Mus On|MusOff|MIDIon|MIDIof|      |      |      |      |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |      |██████|      |      |      |      |██████|      |      |      |
 * `-----------------------------------------------------------------------------------'
 */
[_ADJUST] = LAYOUT_planck_grid(
    ...
    _______, EE_CLR,  MU_NEXT, AU_ON,   AU_OFF,  AG_NORM, AG_SWAP, _______, COLEMAK, _______, PLOVER,  _______,
...
/* Mouse layer
 * ,-----------------------------------------------------------------------------------.
 * |      |      |      |      |      |      |      |WhlUp |WhlL  | M-Up |WhlR  |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl | GUI  |  Alt |Shift |      |      |      |WhlDn |M-Left|M-Down|M-Rgt |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |      |      |      |      |      |      |      |      |      |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |██████|      |      |      |      | Btn1 | Btn2 |      |      |      |
...
[_MOUSE] = LAYOUT_planck_grid(
    _______, _______, _______, _______, _______, _______, _______, MS_WHLU, MS_WHLL, MS_UP,   MS_WHLR, _______,
    KC_LCTL, KC_LWIN, KC_LALT, KC_LSFT, _______, _______, _______, MS_WHLD, MS_LEFT, MS_DOWN, MS_RGHT, _______,
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
